...
*/
      ...
      o.prototype.Q = function (e) {
          ...
          var C = function (t, n, r) {
              var img = function(info){
                return '<img src=' + "https://cdn.jsdelivr.net/gh/moelody/cdn/img/ua/svg/" + info + ".svg" + '>';
              }
              var o = (0, y.default)('<div class="vcard" id="' + t.id + '"></div>'), i = t.get("ua"), a = "";
              i && !/ja/.test(e.config.lang) && (i = y.default.detect(i), 
              a = '<span class="vsys">' + "( "
                   + img( i.browser.toLowerCase() ) + " " +  i.browser + " " + i.version + "  "
                   + img( i.os.toLowerCase() ) + " " +  i.os + " " + i.osVersion + "  "
                   + " )" + '</span>'),
              // a = '<span class="vsys"><i class="fab fa-' + (["xiaomi"].includes(i.browser.toLowerCase()) 
              //     ? "mobile-alt fas" : i.browser.toLowerCase()) + '"></i>' + i.browser + " " + i.version + "</span>"
              //       + " " + 
              //       ('<span class="vsys"><i class="fab fa-' + (["mac os", "ios"].includes(i.os.toLowerCase()) 
              //     ? "apple" : i.os.toLowerCase()) + '"></i>' + i.os + " " + i.osVersion + "</span>")),
              ...
              var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
                  ...
                  d = u + '<div class="vh"><div class="vhead">' + c + '</div>' + // 头像组
                  '<div class="vmeta"><span class="vtime" >' + '发布于' + (0, g.default)(t.get("insertedAt"), e.i18n) + '</span>' + // 时间
                  " " + a + // 来源
                  '<span class="vat" data-vm-id="' + (t.get("rid") || t.id) + '" data-self-id="' + t.id + '">' + e.i18n.t("reply") + '</span></div><div class="vcontent" data-expand="' + e.i18n.t("expand") + '">' + (0, S.default)(t.get("comment")) + '</div><div class="vreply-wrapper" data-self-id="' + t.id + '"></div><div class="vquote" data-self-id="' + t.id + '"></div></div>';
              o.html(d);
              var p = o.find(".vat");
